...
INSERT INTO user(id, first_name, last_name, username, password, email, phone_number, city, birth_date, is_male) 
        VALUES (1, 'Kertész', 'Kászon', 'kaszon', '$2a$10$AiPhjjKGpkixPA8LNtsGZOGkLX6eojo7rUkZSgiUZSAAuXtmSzciS', 'kaszon@gmail.com', '06302003000', 'Budapest', '1990-01-01', true);
INSERT INTO user(id, first_name, last_name, username, password, email, phone_number, city, birth_date, is_male) 
        VALUES (2, 'Polozgai', 'Máté', 'mate', '$2a$10$AiPhjjKGpkixPA8LNtsGZOGkLX6eojo7rUkZSgiUZSAAuXtmSzciS', 'mate@gmail.com', '06303004000', 'Budapest', '1990-01-02', true);
INSERT INTO user(id, first_name, last_name, username, password, email, phone_number, city, birth_date, is_male) 
        VALUES (3, 'Szebenyi', 'Gergely', 'geri', '$2a$10$AiPhjjKGpkixPA8LNtsGZOGkLX6eojo7rUkZSgiUZSAAuXtmSzciS', 'geri@gmail.com', '06304005000', 'Budapest', '1990-01-03', true);
INSERT INTO user(id, first_name, last_name, username, password, email, phone_number, city, birth_date, is_male) 
        VALUES (4, 'Szendrei', 'Ferenc', 'feri', '$2a$10$AiPhjjKGpkixPA8LNtsGZOGkLX6eojo7rUkZSgiUZSAAuXtmSzciS', 'feri@gmail.com', '06305006000', 'Budapest', '1990-01-04', true);
