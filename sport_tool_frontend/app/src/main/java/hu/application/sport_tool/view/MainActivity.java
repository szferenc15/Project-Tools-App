...
import hu.application.sport_tool.model.Event;
import hu.application.sport_tool.model.EventAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView nav_user = (TextView)headerView.findViewById(R.id.nav_header);
        ...
        nav_user.setText("Welcome Ferenc");



        events = new ArrayList<>();

        new GetEventsBasedOnUser().execute("http://10.0.2.2:5000/event/all");
